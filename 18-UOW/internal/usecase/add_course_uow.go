...
import (
	...
	"github.com/pedrogutierresbr/pos-goexpert/18-uow/internal/entity"
	"github.com/pedrogutierresbr/pos-goexpert/18-uow/internal/repository"
	"github.com/pedrogutierresbr/pos-goexpert/18-uow/pkg/uow"
)
...
func (a *AddCourseUseCaseUow) Execute(ctx context.Context, input InputUseCase) error {
	return a.Uow.Do(ctx, func(uow *uow.Uow) error {
		// tudo que for coloado aqui, vai ser feito um begin e um commit / rollback
